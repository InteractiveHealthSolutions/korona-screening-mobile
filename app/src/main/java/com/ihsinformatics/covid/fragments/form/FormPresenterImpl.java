...
public class FormPresenterImpl implements FormContract.Presenter {
    ...
    public List<Question> getQuestions() {
        ...
        questions.add(new Question(1, view.getStringResource(R.string.question_title_exposure), "recent_travel", view.getStringResource(R.string.sec_1_question_1), Arrays.asList(new Option(2, Option.OptionValue.YES), new Option(0, Option.OptionValue.NO)), R.drawable.ic_plane));
        questions.add(new Question(1, view.getStringResource(R.string.question_title_exposure), "contact_traveller", view.getStringResource(R.string.sec_1_question_2), Arrays.asList(new Option(2, Option.OptionValue.YES), new Option(0, Option.OptionValue.NO)), R.drawable.ic_1b));
